...
from gans_pytorch.gan.gan_model import GANModel, ConditionalGANModel, stylegan2_cond_transfer
...
from gan.loss.base import GANLossObject
...
image2measure_opt = optim.Adam(image2measure.parameters(), lr=0.0005)
